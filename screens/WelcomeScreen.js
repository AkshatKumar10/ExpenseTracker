  ...
  return (
    <SafeAreaView className="flex-1 bg-black">
      ...
      <View className="flex-1 justify-center items-center px-4">
        <Text className="text-3xl text-white font-bold mb-20">
          𝙴𝚡𝚙𝚎𝚗𝚜𝚎 𝚃𝚛𝚊𝚌𝚔𝚎𝚛
        </Text>
        ...
        <View className="items-center">
          ...
          <Text className="text-xl text-white mt-5 text-center px-10">
            Do you have trouble in tracking and managing your money expenses? Take
            note of your money expenses with expense tracker app, track them
            easily.
          </Text>
        </View>
